                ...
                <tr key={run.id} className="hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center gap-0.5 justify-end">
                      {run.status === 'failed' && (
                        <button className="p-1 rounded hover:bg-white/10 text-muted-foreground hover:text-foreground" title="Retry">
                          <RotateCcw className="h-3.5 w-3.5" />
                        </button>
                      )}
                      {run.status === 'running' && (
                        <button className="p-1 rounded hover:bg-white/10 text-muted-foreground hover:text-foreground" title="Pause">
                          <Pause className="h-3.5 w-3.5" />
                        </button>
                      )}
                      {['running', 'stalled'].includes(run.status) && (
                        <button className="p-1 rounded hover:bg-red-500/20 text-muted-foreground hover:text-red-400" title="Kill">

#!/usr/bin/env python3
"""CLI: Ingest all videos from a YouTube channel."""
...
from ingestion.channel_scanner import list_channel_videos
...
def main():
    parser = argparse.ArgumentParser(description="Ingest all videos from a YouTube channel")
    ...
    logger.info(f"Scanning channel: {args.channel_url}")
    videos = list_channel_videos(args.channel_url, max_videos=args.max_videos)
